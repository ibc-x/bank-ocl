...
public class BankSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BankPackage.COMPTE: {
				Compte compte = (Compte)theEObject;
				T result = caseCompte(compte);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BankPackage.COMPTE_COURANT: {
				CompteCourant compteCourant = (CompteCourant)theEObject;
				T result = caseCompteCourant(compteCourant);
				if (result == null) result = caseCompte(compteCourant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BankPackage.COMPTE_EPARGNE: {
				CompteEpargne compteEpargne = (CompteEpargne)theEObject;
				T result = caseCompteEpargne(compteEpargne);
				if (result == null) result = caseCompte(compteEpargne);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BankPackage.OPERATION: {
				Operation operation = (Operation)theEObject;
				T result = caseOperation(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BankPackage.EMPLOYE: {
				Employe employe = (Employe)theEObject;
				T result = caseEmploye(employe);
				if (result == null) result = casePersonne(employe);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BankPackage.PERSONNE: {
			...
			case BankPackage.CLIENT: {
				...
				if (result == null) result = casePersonne(client);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BankPackage.GROUPE: {
				Groupe groupe = (Groupe)theEObject;
				T result = caseGroupe(groupe);
				if (result == null) result = casePersonne(groupe);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Compte Courant</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Compte Courant</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCompteCourant(CompteCourant object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Compte Epargne</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Compte Epargne</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCompteEpargne(CompteEpargne object) {
		return null;
	}
